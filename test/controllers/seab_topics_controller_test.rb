...
class SeabTopicsControllerTest < ActionController::TestCase
  ...
  test "should create seab_topic" do
    assert_difference('SeabTopic.count') do
      post :create, seab_topic: { description: @seab_topic.description, subject_id: @seab_topic.subject_id, topic: @seab_topic.topic }
    end
  ...
  test "should update seab_topic" do
    patch :update, id: @seab_topic, seab_topic: { description: @seab_topic.description, subject_id: @seab_topic.subject_id, topic: @seab_topic.topic }
    assert_redirected_to seab_topic_path(assigns(:seab_topic))
  end
